...
> one-stage object detectors use a fixed grid of boxes (like anchors in SSD), while the two-stage detector uses proposal network to generate box proposals.
...
| OverFeat [Reading Note](https://xuuuuuuchen.github.io/2018-07-20-readnote/) | R-CNN [Reading Note](https://xuuuuuuchen.github.io/2018-07-19-readnote/)| 
